...
#define SPRITE_BOUNCING (currSprite->GetStateId() == "bouncing_vertical_right" || currSprite->GetStateId() == "bouncing_vertical_left" || currSprite->GetStateId() == "bouncing_left" || currSprite->GetStateId() == "bouncing_right")
